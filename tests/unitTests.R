...
test_dir("C:/Ceres/GitHub/LandscapesInMotion/R/SpaDES/m/fireWeather/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Ceres/GitHub/LandscapesInMotion/R/SpaDES/m/fireWeather/tests/testthat/test-template.R")
